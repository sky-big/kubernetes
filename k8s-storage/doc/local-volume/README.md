...
standard PVC interface in a simple and portable(轻便的) way.  The PV contains node
affinity information that the system uses to schedule pods to the correct
nodes.  
<font color=#228B22>本地持久化卷允许使用者能够以简单的方便的方式使用PVC的接口方式获得本地存储</font>
...
<font color=#228B22>一个外部静态的提供者是可以帮助简单的管理本地存储一旦一个本地卷被配置出来</font>

## Feature Status
Current status: 1.7 - Alpha  
<font color=#228B22>此文档目前更新到k8s-1.7-alpha版本</font>
